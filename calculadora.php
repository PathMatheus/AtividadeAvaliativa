      ...
      <div class="row">
        <div class="col d-flex justify-content-center">
          ...
          <div class="calculadora">
            ...
            <div class="row">
              <button  onclick="calcular('acao', 'c')" type="button" class="btn btn-dark btn-lg clear font-weight-light">Limpar</button>
            ...
            <!-- na linha 64, ('valor', 11) deveria ser 7 -->
            <!-- na linha 67, ('acao', '+') deveria ser '-' -->
            <div class="row">
              ...
              <button  onclick="calcular('acao', '+')" type="button" class="btn btn-dark btn-lg font-weight-light">+</button>
            </div> <!-- na linha 73, ('valor', 6.5) deveria ser 6 --> 
    ...
    <script>
      function calcular(tipo, valor) {
        ...
        if (tipo === 'acao') {
          ...
          // Verificando operações matemáticas
          ...
          // Verificando resultado '='
            ...
            var resultadoFinal = eval(valorAtual);
            resultado.value = resultadoFinal;
          }
        } 
        else if (tipo === 'valor') {
          // Juntando os elementos para aparecer todos no visor
